...
def test_darf_route_ignores_invalid_periods_from_records_and_provisions(monkeypatch) -> None:
    monkeypatch.setattr(
        "opcoes.web.darf.get_monthly_darf_provisions",
        lambda **_kwargs: {"2026-03": 15.0, " 2026-0": 99.0},
    )
    monkeypatch.setattr(
        "opcoes.web.darf.list_months",
        lambda **_kwargs: [
            SimpleNamespace(period="2026-03", due_date="2026-04-30", amount=15.0, paid_date=None, paid_amount=None),
            SimpleNamespace(period="2026-0", due_date="2026-01-31", amount=1.0, paid_date=None, paid_amount=None),
        ],
    )
    monkeypatch.setattr(
        "opcoes.web.list_monthly_tax_summaries",
    ...
    assert 'period=2026-0"' not in html
    assert "period=2026-0&" not in html
