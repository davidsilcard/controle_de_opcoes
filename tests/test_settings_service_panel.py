            ...
            "services": [
                {
                    ...
                    "next_run_utc": dt.datetime(2026, 4, 2, 5, 0, tzinfo=dt.timezone.utc),
                    "next_run_local": dt.datetime(2026, 4, 2, 2, 0, tzinfo=dt.timezone.utc),
                    "last_run": {
                        "status": "success",
                        "monitor_status": "success",
                        "scheduled_for_display_utc": dt.datetime(2026, 4, 1, 5, 0, tzinfo=dt.timezone.utc),
